...
TSDA = pychrono.ChLinkTSDA() # create the ChLinkTSDA
body1_point = pychrono.ChVectorD(wavelength-0.25,water_level+0.1,0.0)   #store the location of the connection on the first body
body2_point = pychrono.ChVectorD(wavelength+0.25,water_level+0.1,0.0)   #store the location of the connection on the second body


TSDA.Initialize(system.subcomponents[0].ChBody,
                                    system.subcomponents[1].ChBody,
                                    False, body1_point, body2_point, auto_rest_length=True) #initialize the system
